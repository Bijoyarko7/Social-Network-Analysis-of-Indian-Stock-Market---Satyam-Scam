library(readr)
X2019augsep <- read_csv("F:/THESIS related data work/FINAL/prices csv/nov08.csv", 
                        col_types = cols(X1 = col_date(format = "%m/%d/%Y")))
Niftyaugsep <- read_csv("F:/THESIS related data work/FINAL/nifty prices/novdec08.csv", 
...
#Thresholdmatrix_0.2
diag(cor_mat)<-0
cor_mat[cor_mat<0.2]<-0
cor_mat[cor_mat>=0.2]<-1
